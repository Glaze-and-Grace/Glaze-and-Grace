...
//     <a href="#" class="text-2xl font-bold text-gray-800">Glaze and Grace</a>
...
//       <div class="mt-8 space-y-3 rounded-lg border bg-[#17403C] px-2 py-4 sm:px-6">
...
//             <span class="float-right text-[#17403C]">42EU - 8.5US</span>
...
//           <span class="peer-checked border-[#17403C]absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
...
//           <span class="peer-checked:border-[#17403C] absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-[#17403C] bg-white"></span>
...
//     </div>
//     <OrderButtonComponent orderDetails={orderDetails} onOrderPlaced={handleOrderPlaced} />
// </div>
// </div>
// </div>
//   )
